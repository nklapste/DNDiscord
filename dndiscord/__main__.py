"""Main script entry point for the dndiscord"""
import argparse
import logging
import logging.handlers
import sys

from dndiscord.bot import BOT


def main():
    """Startup script for the dndiscord bot"""
    parser = argparse.ArgumentParser(description="dndiscord:")
    ...
    group.add_argument("-tf", "--token-file", type=str, dest="token_file",
                       help="Absolute path to file containing the Discord "
                            "token for the bot")
